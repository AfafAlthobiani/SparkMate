    ...
    >
      ...
      <div className="w-[90%] max-w-7xl mx-auto flex items-center justify-between relative z-10 h-full">
        ...
        >
          ...
          <div className="flex items-center gap-1 sm:gap-2 text-[11px] sm:text-sm font-black text-white whitespace-nowrap overflow-hidden text-ellipsis">
            <span className="text-[#48C2C1]">صدمة الأسعار! ✨</span>
            <span className="hidden xs:inline-block">باقة الغسيل والتعقيم :</span>
            <span className="text-orange-300 bg-white/10 px-2 py-0.5 rounded-md hover:bg-white/15 transition-all">العرض المتكامل 🎁</span>
            <span className="text-white/80">(كنب + سجاد + ستارة + جدران)</span>
            <span className="text-[#48C2C1] font-black text-xs sm:text-[15px] bg-[#48C2C1]/10 px-2 py-0.5 rounded border border-[#48C2C1]/25">209 ريال فقط!</span>
          </div>
