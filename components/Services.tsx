      ...
      <div className="flex justify-center gap-4 mb-14 flex-wrap">
        {(['all', 'tahili', 'shamil', 'commercial'] as const).map((cat) => (
          <button
            ...
            className={`px-8 py-3.5 rounded-full text-[17px] font-extrabold cursor-pointer transition-all border-2 ${
              filter === cat 
              ...
              <div className="p-6 pt-5 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-5.5">
                  <button 
                    ...
                    className="flex items-center justify-center gap-2.5 w-full p-4 bg-gradient-to-r from-[#25d366] to-[#128c7e] text-white rounded-full text-base font-extrabold shadow-md hover:scale-[1.03] hover:shadow-xl hover:shadow-[#25d366]/40 transition-all font-sans cursor-pointer"
                  >
